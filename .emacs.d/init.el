...
;(define-key evil-jmotion-state-map (kbd "C-j") [escape])
;(define-key evil-insert-state-map (kbd "C-j") [escape])
;(define-key evil-replace-state-map (kbd "C-j") [escape])
;(define-key evil-operator-state-map (kbd "C-j") [escape])
